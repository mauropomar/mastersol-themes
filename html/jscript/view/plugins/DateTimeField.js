 ...
 */
Ext.define('MasterSol.view.plugins.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.datetimefield',
    requires: ['MasterSol.view.plugins.DateTimePicker'],
    ...
    createPicker: function() {
        ...
        return Ext.create('MasterSol.view.plugins.DateTimePicker', Ext.merge(initialConfig, parentConfig));
    },
