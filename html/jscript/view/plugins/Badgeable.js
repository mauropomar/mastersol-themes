Ext.define('MasterSol.view.layout.Badgeable', {
    ...
    getInsertAfter: function () {
        return this.insertAfter instanceof Ext.dom.Element ? this.insertAfter : _.isFunction(this.insertAfter) ? this.insertAfter.call(this.cmp) : _.get(this.cmp, this.insertAfter);
    },

    getInsertBefore: function () {
        return this.insertBefore instanceof Ext.dom.Element ? this.insertBefore : _.isFunction(this.insertBefore) ? this.insertBefore.call(this.cmp) : _.get(this.cmp, this.insertBefore);
    },
